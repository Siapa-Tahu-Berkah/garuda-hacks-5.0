      ...
      <div className="relative group" style={{ width: "90%" }}>
        ...
        >
          <div className="text-center">
            ...
            <Button className="bg-white text-black rounded w-40 hover:bg-black hover:text-white">
              Vote
            </Button>
          </div>
        </div>
      <p className="text-center font-bold absolute top-[22.5rem] bottom-0 left-0 right-0">{type}</p>
      </div>
    </>
  );
};
